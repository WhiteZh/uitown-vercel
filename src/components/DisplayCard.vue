...
import {iframeContent, shadowContent} from '@/constants';
...
<template>
  <div class="flex flex-col">
    <div class="flex-grow relative overflow-hidden group">
      <iframe class="rounded-3xl h-full relative bg-[#2b2a2a] w-full" ref="cardContentRoot" :srcdoc="iframeContent(props.html, props.css)"/>
