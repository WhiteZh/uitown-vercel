  ...
  <div class="h-[368px] w-[560px] absolute bg-[linear-gradient(90deg,#8c52ff,#5ce1e6)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-[2rem] flex flex-col">
    ...
    <div class="flex flex-col">
      ...
      <div class="buttons flex flex-row justify-center *:text-[#4e2780] *:w-8 *:h-8 *:cursor-pointer *:mx-0.5">
        ...
        <button>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x mx-auto"
               viewBox="0 0 16 16">
            <path
        ...
        <button>
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-instagram mx-auto"
               viewBox="0 0 16 16">
            <path
